<h2><a href="https://leetcode.com/problems/design-a-leaderboard">Design A Leaderboard</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>Design a Leaderboard class, which has 3 functions:</p>
